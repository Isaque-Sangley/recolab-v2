...
from ..dtos import CreateUserRequest, UpdateUserRequest, UserDTO, UserProfileDTO
from ..queries import GetUserByIdQuery, GetUserProfileQuery, GetUserStatsQuery, ListUsersQuery
...
class UserApplicationService:
    ...
    def __init__(self, user_repository: IUserRepository, rating_repository: IRatingRepository):
        ...
        self.get_profile_query = GetUserProfileQuery(
            user_repository, rating_repository, self.user_profile_service
        )
