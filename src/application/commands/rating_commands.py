...
from ...domain.repositories import IRatingRepository, IUserRepository, IMovieRepository
from ...domain.entities import Rating, User
from ...domain.value_objects import UserId, MovieId, RatingScore, Timestamp
from ...domain.events import DomainEventBus, RatingCreated, RatingUpdated, RatingDeleted
from ..dtos import CreateRatingRequest, UpdateRatingRequest, DeleteRatingRequest, RatingDTO
