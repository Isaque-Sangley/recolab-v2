...
from ....domain.value_objects import UserId, MovieId, RecommendationScore, Timestamp
...
class ModelServer:
    ...
    def _update_latency(self, start_time: datetime) -> None:
        ...
        self._serving_stats["avg_latency_ms"] = (
    ...
    def get_serving_stats(self) -> Dict[str, Any]:
        ...
        cache_hit_rate = (
            self._serving_stats["cache_hits"] / total * 100
            if total > 0 else 0.0
        )
