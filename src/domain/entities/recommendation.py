...
from ..value_objects import MovieId, RecommendationScore, Timestamp, UserId
...
class Recommendation:
    ...
    def get_explanation(self) -> str:
        ...
        base_explanation = explanations.get(self.source, "Recomendado pelo sistema")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and self.movie_id == other.movie_id
