...
from src.infrastructure.persistence.orm_models import RatingORM, MovieORM
from src.infrastructure.ml import ModelTrainer, TrainingConfig, ModelRegistry, TrainingStrategy
from src.domain.events import ModelType, DomainEventBus
...
async def main():
    ...
    if result.is_success():
        ...
        async for session in get_session():
            ...
            await model_registry.promote_to_champion(
                model_type=config.model_type,
                version=version
            )
